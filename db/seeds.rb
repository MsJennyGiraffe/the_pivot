...
items = [
        ...
        { title: "Bourbon",
          price: 3,
          description: "This batch of Bourbon is made by following the small-batch technique inspired by frontiersmen over 150 years ago. Only the highest quality ingredients are used. This bourbon's subtlety and complexity stem from its unique blend of rye, corn and barley malt, along with special strains of yeast. Because frontier bourbon is especially high in rye content, it has a bold and spicy character with a distinctively smooth, clean finish.",
          image_path: "https://img0.etsystatic.com/028/1/7947782/il_570xN.581725526_7vdb.jpg",
          category_id: 1,
          weight: 3,
          stock: 1000
        },
        { title: "Women's Prairie Dress",
          price: 20,
        ...
        { title: "Corn Bread",
          price: 2,
          description: "Homemade Corn Bread sold by the sqaure",
